  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="resources/images/download2.png" alt="Bangalore" style="width:100%;">
       ...
       <div class="item">
      <img src="resources/images/images2.jpg" alt="RAMANAGARA" style="width:100%;">
        <div class="carousel-caption">
        <h3>RAMANAGARA</h3>
          <p>PLACE OF GOD</p>
        </div>
       ...
       <div class="item">
      <img src="resources/images/download10.jpg" alt="MYSORE" style="width:100%;">
        <div class="carousel-caption">
        <h3>MYSORE</h3>
      ...
      <div class="item">
      <img src="resources/images/images1.jpg" alt="Chennai" style="width:100%;">
        <div class="carousel-caption">
        <h3>Chennai</h3>
      ...
      <div class="item">
      <img src="resources/images/donload12.jpg" alt="Chennai" style="width:100%;">
         <div class="carousel-caption">
          <h3>New delhi</h3>
       ...
       <div class="item">
       <img src="resources/images/download7.jpg" alt="hyderabad" style="width:100%;">
         <div class="carousel-caption">
         <h3>hyerabad</h3>
